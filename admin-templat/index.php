        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <h5 class="card-header">Tableau de produit</h5>
                ...
                ?>
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $value->getNom_Produit() ?></strong></td>
                        <td><?php echo $value->getNom_Categorie() ?></td>
                        <td><?php echo $value->getPrix() ?></td>
                        <td><span class="badge bg-label-primary me-1"><?php echo $value->getQuantite_stock() ?></span></td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item"  href="modifier.php?id=<?php echo $value -> getId_Produit() ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Modifier</a
                              >
                              <a class="dropdown-item" href="suprimer.php?id=<?php echo $value -> getId_Produit() ?>"
