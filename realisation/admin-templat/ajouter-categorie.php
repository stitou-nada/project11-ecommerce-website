            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">ajouter Categorie</h5>
                    <!-- Account -->
                    <div class="card-body">
                      ...
                      <form id="formAccountSettings" method="POST" >
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Nom categorie</label>
                            <input
                              class="form-control"
                              type="text"
                              id="firstName"
                        ...
                        <div class="mt-2">
                          <a href="index.php" type="submit" class="btn btn-primary me-2">ajouter Categorie</a>
