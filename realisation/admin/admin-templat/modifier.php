                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                           src="../admin-templat/img/<?php echo $value->getPhoto()?>"
                          alt="user-avatar"
                      ...
                      <form id="formAccountSettings" method="POST" >
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="prix" id="lastName"
                    ...
                    <?php  foreach($afficherdata as $affichervalue){ ?>
                      <option value="<?= $affichervalue->getId_Categorie()?>"><?= $affichervalue->getNom_Categorie();} ?> </option>
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <input class="form-control" type="text"  name="quantite_stock"id="lastName"  
                          value="<?php echo $value->getQuantite_stock() ?>" />
                        </div>
                        <div class="mt-2">
                          <a href="index.php" type="submit" class="btn btn-primary me-2">modifier</a>
